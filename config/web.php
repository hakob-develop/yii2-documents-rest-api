...
$config = [
    ...
    'components' => [
        'request' => [
            ...
            'cookieValidationKey' => 'jM7Vcli8HXAct7vb50zlZVoPm0xKXabC',
        ],
        'cache' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'OPTIONS <controller:[\w-]+>s/<id:\d+>' => '<controller>/options',
        ...
        'request' => [
            ...
            'cookieValidationKey' => '1VwIjoKRv9mGh6NTZnmvFu1roaeC2zdQ',
        ],
    ],
    'params' => $params,
];
